...
public class Program {
	public static void main(String[] args) {
		...
		Map<Integer, HashMap<String, Double>> statistics = city.getStatistics();
		...
		XYSeries series3 = new XYSeries("Quantidade de pessoas recuperadas");
		
		
		for (int i = 0; i < numberOfGerations; i++) {
		    series1.add(i, statistics.get(i).get(StatePossibles.SUSCETIVEL.getStateName()));
		    series2.add(i, statistics.get(i).get(StatePossibles.INFECTADO.getStateName()));
		    series3.add(i, statistics.get(i).get(StatePossibles.RECUPERADO.getStateName()));
		}	
